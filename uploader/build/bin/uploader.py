...
def csv_upload_process(file_path):
    ...
    if metadata:
        ...
        logger.warning(f"Could not parse CSV filename: {file_to_upload.name}, uploading to root")
        blob_path = None
...
def video_upload_process(file_path):
    ...
    if metadata:
        ...
        logger.warning(f"Could not parse video filename: {file_to_upload.name}, uploading to root")
        blob_path = None
